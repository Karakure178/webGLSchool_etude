 ...
 */
export const gltfLoad_group = (path, scene, material, meshLoad_frag, num, radius, circle_fan) => {
  // 実装参考：https://threejs.org/docs/#examples/en/loaders/GLTFLoader
  const loader = new GLTFLoader();
  ...
  loader.load(
    ...
    function (gltf) {
      ...
      //scene.add(group);
      const angle = 360 / num;
      //const circle_fan = new THREE.Group();
      ...
      for (let i = 0; i < num; i++) {
        ...
        //const scale_random = Math.random() * 0.5 + 0.5;
        //group_clone.scale.set(scale_random, scale_random, scale_random);
